...
namespace Simulator_Ria.Services
{
    public static class Data
    {
        ...
        private static int _idIncremental = 0;
        private static Random _random = new Random();


        private static string[] FIRST_NAMES = new string[] { "Aarav", "Yuki", "Amina", "Nikolai", "Mei", "Jakub", "Leila", "Rafael", "Priya", "Elijah", "Sakura", "Mohammed", "Ananya", "Gabriel", "Zeynep" };
        private static string[] LAST_NAMES = new string[] { "Wang", "Kim", "Nguyen", "Patel", "Silva", "Ivanov", "Kovács", "Müller", "Santos", "Cohen", "Saito", "Khan", "Nowak", "Dubois" };
